...
if (isset($_POST['submit'])) {
    ...
    if (isset($_SESSION['RegId'])) {
        ...
        if (isset($_FILES['file']) && $_FILES['file']['error'] === 0) {
            ...
            $uploadDirectory = __DIR__ . '/../../start-up/upload/';
            ...
            if (move_uploaded_file($fileTmpPath, $uploadPath)) {
                ...
                $sql = "INSERT INTO tutorail (Pid, Title, Description, File) VALUES (?, ?, ?, ?)";
...
<div class="container text-center mt-5">
    <div class="row">
        <div class="col">
            <p class="text-primary fs-5">Add Tutorial</p>
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-10 col-md-8 col-lg-6 cont">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="file" class="form-label fs-5">Video File</label>
                    <input type="file" name="file" class="form-control" id="file" accept="video/*" required>
                </div>
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary" name="submit">Add Tutorial</button>
                </div>
            </form>
        </div>
    </div>
