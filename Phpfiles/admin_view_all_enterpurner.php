...
<div class="container text-center col-12 col-md-3 mt-5">
    ...
    <div class="row">
        <div class="col">
            <p class="fw-bolder">New Entrepreneurs</p>
        </div>
    </div>
    <div class="row">
...
<div class="container mt-5 p-3 cont">
    <div class="table-responsive">
        ...
        $sql = "SELECT rg.Id, rg.Profile, rg.FirstName, rg.CompanyName,  rg.Location, rg.Contactnumber 
        FROM register rg 
        INNER JOIN login lg ON rg.id = lg.RegId where lg.Usertype='ENTREPRENEUR' ORDER BY rg.Id DESC LIMIT 5";
            ...
            <table class="table align-middle">
                <thead class="bg-primary text-white">
                    <tr>
                        ...
                        <th style="min-width: 150px;">CompanyName</th>
                        <th style="min-width: 150px;">Location</th>
                        <th style="min-width: 120px;">Contactnumber</th>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            <th>
                                <div class="d-flex align-items-center flex-wrap">
                                    ...
                                    <span class="ms-2 text-truncate" style="max-width: 100px;">
                                        <?php
                                        $first = isset($row['FirstName']) ? $row['FirstName'] : '';
                                        echo $first
                                        ?>
                                    </span>
                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                    <a href="Eenter_active.php?id=<?php echo $row['Id']; ?>"
